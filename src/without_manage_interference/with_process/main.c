...
int main(int argc, char **argv)
{
  ...
  {
    execlp("./process_debit","process_debit_pid", argv[1], argv[2], argv[3],shmid_char, NULL);
    perror("execlp"); 
    exit(EXIT_SUCCESS);
  }
  ...
  {
    execlp("./process_credit","process_credit_pid", argv[1], argv[2], argv[3],shmid_char, NULL);
    perror("execlp"); 
    exit(EXIT_SUCCESS);
  }
